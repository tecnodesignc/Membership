...
class CongregationController extends BasePublicController
{
    /**
    ...
    public function index()
    {
        ...
        return view('membership::frontend.congregations.index', compact(''));
    }
    ...
    {
        return view('membership::frontend.congregations.create');
    }
    ...
    {
        return view('membership::frontend.congregations.edit', compact('congregation'));
    }
