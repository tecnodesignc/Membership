...
class DistrictController extends BasePublicController
{
    /**
    ...
    public function index()
    {
        ...
        return view('membership::fronted.districts.index', compact(''));
    }
    ...
    {
        return view('membership::fronted.districts.create');
    }
    ...
    {
        return view('membership::fronted.districts.edit', compact('district'));
    }
