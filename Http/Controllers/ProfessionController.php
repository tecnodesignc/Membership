...
class ProfessionController extends BasePublicController
{
    /**
    ...
    public function index()
    {
        ...
        return view('membership::fronted.professions.index', compact(''));
    }
    ...
    {
        return view('membership::fronted.professions.create');
    }
    ...
    {
        return view('membership::fronted.professions.edit', compact('profession'));
    }
