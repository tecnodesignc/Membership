...
class CommitteeController extends BasePublicController
{
    /**
    ...
    public function index()
    {
        ...
        return view('membership::fronted.committees.index', compact(''));
    }
    ...
    {
        return view('membership::fronted.committees.create');
    }
    ...
    {
        return view('membership::fronted.committees.edit', compact('committee'));
    }
