...
class AddressController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        return view('membership::admin.addresses.index', compact(''));
    }
    ...
    {
        return view('membership::admin.addresses.create');
    }
    ...
    {
        return view('membership::admin.addresses.edit', compact('address'));
    }
